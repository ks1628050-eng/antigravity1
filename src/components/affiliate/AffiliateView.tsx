        ...
        <div className="lg:col-span-6 p-6 rounded-3xl bg-slate-900/80 border border-slate-800 shadow-xl space-y-5">
          ...
          <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-2">
            <span className="text-xs font-bold text-slate-300 flex items-center gap-2">
              ...
              <span>Ambassador Earnings & Automated Settlement</span>
            </span>
            <p className="text-xs text-slate-300 leading-relaxed">
              Ambassador referral commissions (30%) are tracked with your referral code and credited to your verified student account at the end of each billing cycle.
            </p>
            <div className="flex items-center gap-2 text-[11px] text-emerald-400 font-semibold pt-1">
              <CheckCircle2 className="w-3.5 h-3.5" />
              <span>Direct Bank / UPI Settlement Enabled</span>
            </div>
          </div>
        </div>
